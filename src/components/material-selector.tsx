...
import { EV_STAT_ORDER, MATERIAL_CATEGORY_ORDER, TYPE_COLORS } from "@/lib/labels";
import type { MaterialInfo, SpawnBait } from "@/lib/types";
import { type UiLabels, materialSuffix } from "@/components/shared";
